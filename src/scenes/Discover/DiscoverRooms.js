...
class DiscoverScreen extends Component {
  ...
  componentWillMount(){
    ...
    convertToArray(museums.sections).sort((a, b) => a.floor - b.floor).forEach(item => {            
      const collectionArr = [];
    ...
    if(object) {
      ...
      sections = [rightSection, ...sections.filter(section => section.sync_id !== object.section.sync_id)]
    }
