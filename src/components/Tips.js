      ...
      case 'collection':
        ...
        return (
          <Defs>
            <Mask id="mask" x="0" y="0" height={height} width={width}>
              <Rect height="100%" width="100%" fill="white" />
              <Circle id="Circle" r={120} cx={cx} cy={position.vertical*180} stroke="green" strokeWidth="4" />
            </Mask>
            <Circle id="Circle" r={120} cx={cx} cy={position.vertical*180} stroke="green" strokeWidth="4" />
          </Defs>
        );
      case 'chat':
        return (
          <Defs>
            <Mask id="mask" x="0" y="0" height={height} width={width}>
              <Rect height="100%" width="100%" fill="white" />
              <Circle id="Circle" r={175} cx={width/2 - 25} cy={height/2 + 25} stroke="green" strokeWidth="4" />
            </Mask>
            <Circle id="Circle" r={175} cx={width/2 - 25} cy={height/2 + 25} stroke="green" strokeWidth="4" />
          </Defs>
        );
